...
#
# Generated by export_simulation on Sun Jun 21 12:31:03 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './top_level_block_design.sh' script.

./top_level_block_design.sh -reset_run
...
./top_level_block_design.sh -noclean_files

For more information on the script, please type './top_level_block_design.sh -help'.
