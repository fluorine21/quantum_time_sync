...
HD_PWD='C:/James/test_project/test_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_block_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_block_design_wrapper.tcl -notrace
