...
HD_PWD='C:/James/test_project/test_project.runs/top_level_block_design_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_block_design_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_block_design_axi_gpio_0_0.tcl
