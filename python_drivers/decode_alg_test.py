...
logfile = "decode_test_results.txt"
...
for loss_rate in range(0, 50, 5):
    for num_dark_counts in range(0, 20):
        for stream_len in range(5, 1000, 25):
            ...
            for test_num in range(0, 100):
                ...
                decoded_stream = ju.decode_pulse_list(pulse_list, period, bin_number, bin_size, stream_len)
