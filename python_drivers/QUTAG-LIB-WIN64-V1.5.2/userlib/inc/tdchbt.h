 ...
 */
/*****************************************************************************/
/* $Id: tdchbt.h,v 1.3 2019/04/02 15:57:17 trurl Exp $ */
 ...
 *  If the function is not called, default values are in place.
 *  The function implicitly clears the correlation functions.
 *  @param channel1  First  channel number, Range = 1...20, default = 1
 *  @param channel2  Second channel number, Range = 1...20, default = 2
 *  @return          Error code
 */
