...
set boards {
    ...
    openjtag3 {FtdiConfig FT4232H FirmwareId 0x584a0004 Vendor Xilinx Product {HW-Z1-ZCU111 FT4232H} Manufacturer Xilinx Description "Xilinx MPSoC ZCU111 Eval Kit"}
}
