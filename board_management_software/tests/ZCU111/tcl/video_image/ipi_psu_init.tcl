...
set psu_ddr_init_data {
    ...
    # figured to support DDR4. Unit: Multiples of 32 clocks.
		# PSU_DDRC_DRAMTMG11_POST_MPSM_GAP_X32                                            0x75
    ...
    # ion by 2, and round it up to next integer.
		...
		#(OFFSET, MASK, VALUE)      (0XFD07012C, 0x7F1F031FU ,0x7507010EU)  */
    mask_write 0XFD07012C 0x7F1F031F 0x7507010E
    ...
    # le. Unit: 1024 clocks
		# PSU_DDRC_DFIUPD1_DFI_T_CTRLUPD_INTERVAL_MIN_X1024                               0x34
    ...
    # ocks
		# PSU_DDRC_DFIUPD1_DFI_T_CTRLUPD_INTERVAL_MAX_X1024                               0xce

		# DFI Update Register 1
		#(OFFSET, MASK, VALUE)      (0XFD0701A4, 0x00FF00FFU ,0x003400CEU)  */
    mask_write 0XFD0701A4 0x00FF00FF 0x003400CE
    ...
    mask_write 0XFD080024 0xFFFFFFFF 0x010100F4
		...
		# PLL Power-Down Time
		# PSU_DDR_PHY_PTR0_TPLLPD                                                         0x34

		# PLL Gear Shift Time
		# PSU_DDR_PHY_PTR0_TPLLGS                                                         0x20d0

		# PHY Reset Time
		# PSU_DDR_PHY_PTR0_TPHYRST                                                        0x10

		# PHY Timing Register 0
		#(OFFSET, MASK, VALUE)      (0XFD080040, 0xFFFFFFFFU ,0x06883410U)  */
    mask_write 0XFD080040 0xFFFFFFFF 0x06883410
		# Register : PTR1 @ 0XFD080044</p>

		# PLL Lock Time
		# PSU_DDR_PHY_PTR1_TPLLLOCK                                                       0x3450

		# Reserved. Returns zeroes on reads.
		# PSU_DDR_PHY_PTR1_RESERVED_15_13                                                 0x0

		# PLL Reset Time
		# PSU_DDR_PHY_PTR1_TPLLRST                                                        0x9d4

		# PHY Timing Register 1
		#(OFFSET, MASK, VALUE)      (0XFD080044, 0xFFFFFFFFU ,0x345009D4U)  */
    mask_write 0XFD080044 0xFFFFFFFF 0x345009D4
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180134 0x000000FE 0x000000C0
		...
		#(OFFSET, MASK, VALUE)      (0XFF180204, 0x7FFFFFFFU ,0x52240000U)  */
    mask_write 0XFF180204 0x7FFFFFFF 0x52240000
