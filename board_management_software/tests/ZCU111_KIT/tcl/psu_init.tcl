...
set psu_clock_init_data {
    ...
    mask_write 0XFD1A0074 0x013F3F07 0x01012A00
    ...
    mask_write 0XFD1A007C 0x013F3F07 0x01012700
...
set psu_ddr_init_data {
    ...
    # LPDDR3/LPDDR4 - Value to write to MR2 register
		...
		#(OFFSET, MASK, VALUE)      (0XFD0700DC, 0xFFFFFFFFU ,0x09240301U)  */
    mask_write 0XFD0700DC 0xFFFFFFFF 0x09240301
    ...
    #  next integer.
		...
		#(OFFSET, MASK, VALUE)      (0XFD070108, 0x3F3F3F3FU ,0x0607060DU)  */
    mask_write 0XFD070108 0x3F3F3F3F 0x0607060D
    ...
    # uld be set to RoundUp(RoundUp(tRP/tCK)/2). Unit: Clocks.
		...
		#(OFFSET, MASK, VALUE)      (0XFD070110, 0x1F0F0F1FU ,0x07030408U)  */
    mask_write 0XFD070110 0x1F0F0F1F 0x07030408
    ...
    # figured to support DDR4. Unit: Multiples of 32 clocks.
		# PSU_DDRC_DRAMTMG11_POST_MPSM_GAP_X32                                            0x48
    ...
    # ion by 2, and round it up to next integer.
		...
		#(OFFSET, MASK, VALUE)      (0XFD07012C, 0x7F1F031FU ,0x4808010EU)  */
    mask_write 0XFD07012C 0x7F1F031F 0x4808010E
    ...
    # ycle of latency through the RDIMM.
		...
		#(OFFSET, MASK, VALUE)      (0XFD070190, 0x1FBFBF3FU ,0x048A8209U)  */
    mask_write 0XFD070190 0x1FBFBF3F 0x048A8209
    ...
    # cification for correct value.
		...
		#(OFFSET, MASK, VALUE)      (0XFD0701B4, 0x00003F3FU ,0x00000804U)  */
    mask_write 0XFD0701B4 0x00003F3F 0x00000804
    ...
    mask_write 0XFD080040 0xFFFFFFFF 0x2C096010
		...
		# PLL Lock Time
		# PSU_DDR_PHY_PTR1_TPLLLOCK                                                       0xa97e
		...
		#(OFFSET, MASK, VALUE)      (0XFD080044, 0xFFFFFFFFU ,0xA97E1460U)  */
    mask_write 0XFD080044 0xFFFFFFFF 0xA97E1460
    ...
    mask_write 0XFD080100 0xFFFFFFFF 0x0800040C
		...
		#(OFFSET, MASK, VALUE)      (0XFD080110, 0xFFFFFFFFU ,0x08260E09U)  */
    mask_write 0XFD080110 0xFFFFFFFF 0x08260E09
    ...
    mask_write 0XFD080120 0xFFFFFFFF 0x01382B08
		...
		#(OFFSET, MASK, VALUE)      (0XFD080124, 0xFFFFFFFFU ,0x00360E09U)  */
    mask_write 0XFD080124 0xFFFFFFFF 0x00360E09
    ...
    # be programmed to 0x0.
		...
		#(OFFSET, MASK, VALUE)      (0XFD080180, 0xFFFFFFFFU ,0x00000824U)  */
    mask_write 0XFD080180 0xFFFFFFFF 0x00000824
